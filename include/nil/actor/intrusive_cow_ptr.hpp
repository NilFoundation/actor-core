...
namespace nil {
    namespace actor {
        ...
        public:
            ...
            template<class Y>
            intrusive_cow_ptr(intrusive_cow_ptr<Y> other) noexcept : ptr_(other.detach(), false) {
                // nop
            }
            ...
            explicit intrusive_cow_ptr(pointer ptr, bool add_ref = true) noexcept : ptr_(ptr, add_ref) {
                // nop
            }
